...
router.get("/best-selling/products",   dashboardController.getBestSellingProducts);
router.get("/best-selling/categories", dashboardController.getBestSellingCategories);
...
router.post("/categories",                 uploadCategory.single("image"), adminController.addCategory);
router.post("/categories/edit/:id",        uploadCategory.single("image"), adminController.editCategory);
router.patch("/categories/toggleCategoryStatus/:id", adminController.toggleCategoryStatus);
...
router.post("/products/add",        uploadProduct.array("productImages", 5), productController.addProduct);
router.post("/products/edit",       uploadProduct.array("productImages", 5), productController.editProduct);
